...
using AlijadoIPT101.AlijadoDomain.Commands;
using AlijadoIPT101.AlijadoDomain.Queries;
using AlijadoIPT101.AlijadoFramework;
using AlijadoIPT101.AlijadoFramework.Commands;
using AlijadoIPT101.AlijadoFramework.Queries;
using AlijadoIPT101.AlijadoYouTubeViewer.Stores;
using AlijadoIPT101.AlijadoYouTubeViewer.ViewModels;
using AlijadoIPT101.AlijadoYouTubeViewer.HostBuilders;
using Microsoft.EntityFrameworkCore;

namespace AlijadoIPT101.AlijadoYouTubeViewer
{
    /// <summary>
